/**
 * @file run_CS10.cpp
 * @brief CS10: Autonomous Pesticide Spraying Drone (Author-Constructed / Validation Case Study)
 *
...
static const std::string ASSET_DIR = "assets/CS10_Drone/";
...
int main(int argc, char* argv[])
{
    try {
        ...
        std::string csv_path = results_folder + "CS10_results.csv";
        ...
        // ────────────────────────────────────────────────────────────────────
        std::cout << "=========================================================" << std::endl;
        std::cout << "=== CS10: Autonomous Pesticide Spraying Drone          ===" << std::endl;
        ...
        std::cout << "Verdict: " << (ok_r1 ? "TRUE (semantically aligned)"
                                           : "FALSE (NOT aligned)") << "\n";
        r1.print();
        r1.append_to_csv(csv, "CS10_aligned");
        ...
        std::cout << "Verdict: " << (ok_r3 ? "TRUE (drift not detected)"
                  ...
                  << "\n";
        r3.print();
        r3.append_to_csv(csv, "CS10_thresh_drift");
        ...
        std::cout << "\nVerdict under domain_v2.ont: "
                  ...
                  << "\n";
        r4.print();
        r4.append_to_csv(csv, "CS10_evo_v2");
