/**
 * @file run_CS9.cpp
 * @brief CS9: Precision Irrigation System (Author-Constructed / ISO 11783 ISOBUS / FAO-56)
 *
...
static const std::string ASSET_DIR = "assets/CS9_Irrigation/";
...
int main(int argc, char* argv[])
{
    try {
        ...
        std::string csv_path = results_folder + "CS9_results.csv";
        ...
        // ────────────────────────────────────────────────────────────────────
        std::cout << "=== CS9: Precision Irrigation System ===" << std::endl;
        ...
        r1.print();
        r1.append_to_csv(csv, "CS9_aligned");
        ...
        std::cout << "Verdict: " << (ok_r3 ? "TRUE (drift not bisimulation-critical)"
                  ...
                  << std::endl;
        r3.print();
        r3.append_to_csv(csv, "CS9_thresh_drift");
        ...
        std::cout << "Verdict under domain_v2.ont: "
                  ...
                  << std::endl;
        r4.print();
        r4.append_to_csv(csv, "CS9_evo_v2");
